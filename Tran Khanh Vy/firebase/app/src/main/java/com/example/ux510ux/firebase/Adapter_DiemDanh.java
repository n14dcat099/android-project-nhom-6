...
public class Adapter_DiemDanh extends ArrayAdapter {
    Context context;
    int layout;
    ArrayList<DiemDanh> arrayList;


    public Adapter_DiemDanh(@NonNull Context context, int resource, @NonNull  ArrayList<DiemDanh> objects) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        DiemDanh diemDanh =new DiemDanh(arrayList.get(position));
        txtTen.setText(diemDanh.getTenlop());
        txtGia.setText(String.valueOf( diemDanh.getSiSolop()));
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatabaseReference myRef = FirebaseDatabase.getInstance().getReference("DiemDanh");
