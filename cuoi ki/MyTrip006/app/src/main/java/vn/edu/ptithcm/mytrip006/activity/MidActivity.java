...
public class MidActivity extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener {
    private ImageButton btnNorth;   private ImageButton btnSouth;   private ImageButton btnMid;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.action_popular:
                    ...
                    Intent i_popular = new Intent( MidActivity.this , Popular.class );
                    startActivity( i_popular );
                    break;

                case R.id.action_my_places:
                    //switchToMyPlacesFragment();
                    Intent i_myplace = new Intent( MidActivity.this,MyPlace.class );
                    startActivity( i_myplace );
                    break;
                case R.id.action_favorites:
                    //switchToFavoritesFragment();
                    Intent i_favorite = new Intent( MidActivity.this,Favorite.class );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(MidActivity.this,AddActivity.class);
       ...
       /* addControls();
        ...
        Setting.settings("Miền Trung", setColor, actionBar, getApplicationContext());
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent(MidActivity.this,HelpActivity.class);
            startActivity(intent);
            overridePendingTransition(R.anim.slide_from_left,R.anim.slide_from_right);
            finish();
        }else if (id == R.id.nav_setting){
            Intent in = new Intent(MidActivity.this,ColorSettingActivity.class);
            startActivity(in);
            finish();
        }
    ...
    */
    ...
    /*    btnMid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MidActivity.this,MidActivity.class);
                startActivity(intent);
            }
        });*/
        btnNorth.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MidActivity.this, NorthActivity.class);
        ...
        btnSouth.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MidActivity.this, SouthActivity.class);
                startActivity(intent);
