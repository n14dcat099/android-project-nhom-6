...
public class Favorite extends AppCompatActivity
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.action_popular:
                    ...
                    Intent i_popular = new Intent(Favorite.this, Popular.class);
                    startActivity(i_popular);
                    break;

                case R.id.action_my_places:
                    //switchToMyPlacesFragment();
                    Intent i_myplace = new Intent(Favorite.this, MyPlace.class);
                    startActivity(i_myplace);
                    break;
                case R.id.action_favorites:
                    //switchToFavoritesFragment();
                    Intent i_favorite = new Intent(Favorite.this, Favorite.class);
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Favorite.this, AddActivity.class);
       ...
       /* getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        TabLayout tabLayout = (TabLayout) findViewById( R.id.tabLayoutFragmentFavorite );
        tabLayout.addTab( tabLayout.newTab().setText( "Du lich" ) );
        tabLayout.addTab( tabLayout.newTab().setText( "Am Thuc" ) );
        //tabLayout.addTab( tabLayout.newTab().setText( "Nghi Duong" ) );
        tabLayout.setTabGravity( TabLayout.GRAVITY_FILL );

        final ViewPager viewPager = (ViewPager) findViewById( R.id.viewPagerFragmentFavorite );
        final PageAdapterFavorite adapter = new PageAdapterFavorite( getSupportFragmentManager() , tabLayout.getTabCount() );
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent(Favorite.this, HelpActivity.class);
            startActivity(intent);
            overridePendingTransition(R.anim.slide_from_left, R.anim.slide_from_right);
            finish();
        } else if (id == R.id.nav_setting) {
            Intent in = new Intent(Favorite.this, ColorSettingActivity.class);
            startActivity(in);
