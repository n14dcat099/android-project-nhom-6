...
public class MainActivity extends AppCompatActivity {
    ...
    Adapter_ORDER adapterDienThoai;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterDienThoai=new Adapter_ORDER(MainActivity.this,R.layout.layout_item_lop,arrayList);
        ...
        myRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ORDER order = new ORDER(dataSnapshot.getKey().toString(),Integer.parseInt(dataSnapshot.getValue().toString()));
                arrayList.add(order);
